...
var assetTypeRouter = require('./routes/asset-type');
var assetStatusRouter = require('./routes/asset-status');
...
app.use('/asset-type', authMiddleware, assetTypeRouter);
app.use('/asset-status', authMiddleware, assetStatusRouter);
